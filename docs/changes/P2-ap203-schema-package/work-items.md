...
Status evidence as of this revision: AP203-001 through AP203-004 are integrated with complete proof
and `Ready` reviews. The AP203-004 implementation range is `57fea41..3b84aa3`; its fixed OCCT fixture,
typed semantic baseline, and unsupported-extension boundary are the approved inputs to AP203-005 and
AP203-006.
