...
| Integrated revision proof | The source candidate commits `da6e096` and `69ae10c` were independently reviewed Ready. Their current-baseline equivalents are `67fe528` and `692d4ee`; the exact migrated range remains subject to the current integration review before downstream use. |
