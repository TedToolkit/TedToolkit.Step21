...
| --- | --- | --- | --- | --- | --- |
| AP214-001 | 固定并可重现地编译 AP214 schema baseline，交付来源、许可、descriptor 与完整生成 API 基线 | Owns AC-02 / Supports AC-06 | None | In progress | `work-items/AP214-001-reproducible-schema-baseline.md` |
