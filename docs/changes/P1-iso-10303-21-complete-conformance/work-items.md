...
| ISO21-006 | 交付不污染核心 runtime 的 Annex F ECMAScript binding | Owns AC-08 / Supports AC-02 / Supports AC-09 | ISO21-001: 已验证的 anchor/value 模型；ISO21-004: 已验证的 population 模型 | In progress | `work-items/ISO21-006-ecmascript-binding.md` |
