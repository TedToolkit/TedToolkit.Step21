...
| ISO21-005 | 交付由 schema 定义文档显式提供的 Part 21 短名与物理映射输入 | Supports AC-07 / Supports AC-01 / Supports AC-02 | ISO21-001: 已验证的 occurrence/constant-name contract 与 generated lookup seam | Approved | `work-items/ISO21-005-express-mapping-closure.md` |
