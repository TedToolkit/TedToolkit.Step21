...
| ISO21-007 | 交付 distributed/archive/signature/binding 的配额、威胁与原子性闭环 | Owns AC-09 / Supports AC-01 / Supports AC-02 | ISO21-002: 已验证的 resource/archive 边界；ISO21-003: 已验证的 CMS policy；ISO21-004: 已验证的 population 边界；ISO21-006: 已验证的核心隔离 | In progress | `work-items/ISO21-007-security-atomicity.md` |
