...
| ISO21-004 | 交付 Annex E 全部 schema-population 确定方法与显式 domain equivalence | Owns AC-06 / Supports AC-02 / Supports AC-08 / Supports AC-09 | ISO21-001: 已验证的 occurrence 模型；ISO21-002: 已验证的外部结构与身份解析 | In progress | `work-items/ISO21-004-schema-populations.md` |
