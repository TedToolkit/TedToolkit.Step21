...
Aggregate projection preserves every declaration form. The current [generated descriptor boundary](generated-schema-descriptors.md) hydrates and projects literal-bounded, non-nested simple aggregates. It does not yet execute EXPRESS rules, map symbolic bounds or complex components, enumerate nested physical entity references, or serialize an exchange file. Those behaviors belong to the reference, validation, complex-mapping, read, and write work items.
